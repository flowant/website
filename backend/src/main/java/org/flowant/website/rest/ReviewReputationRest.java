...
public class ReviewReputationRest extends IdCidRepositoryRest<ReviewReputation, ReviewReputationRepository> {
    ...
    @DeleteMapping(value = PATH_REVIEW_REPUTATION + PATH_SEG_ID_CID)
